            ...
            <div className="card border-0 m-5">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  A fun, interactive application where users can browse designs
                  or publish their own. A full stack web application powered by
                  React.
                </p>
            ...
            <div className="card border-0 m-5">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  image two times or you lose the game! My first application
                  built using React.
                </p>
                <p className="card-text text-center">
                  <a
          ...
          <div className="col-xs-12 col-md-6 d-flex justify-content-center">
            <div className="card border-0 m-5">
              ...
              <div className="card-body">
                ...
                <br />
                <p className="card-text">
                  Customize your own Marvel Superhero. Create matching
                  superheros to unlock trophies.
                </p>
                <p className="card-text text-center">
          ...
          <div className="col-xs-12 col-md-6 d-flex justify-content-center">
            <div className="card border-0 m-5">
              ...
              <div className="card-body">
                ...
                <br />
                <p className="card-text">
                  Search for news about your favorite NBA players and teams.
                  Find tickets to see your favorite team. My first web
                  application build 8 weeks into the University of Pennsylvania
                  Coding Bootcamp.
                </p>
                <p className="card-text text-center">
