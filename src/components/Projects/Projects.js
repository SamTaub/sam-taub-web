                    ...
                    <div className="col-xs-12 col-md-6 d-flex justify-content-center">
                        <div className="card border-0 m-5">
                            ...
                            <div className="card-body">
                                ...
                                < br />
                                <p className="card-text">A fun, interactive application where users can browse designs or publish their own.  A full stack web application powered by React.</p>
                                <p className="card-text text-center"><a href="//github.com/SamTaub/project-3" target="_blank">View Github</a></p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xs-12 col-md-6 d-flex justify-content-center">
                        <div className="card border-0 m-5">
                            ...
                            <div className="card-body">
                                ...
                                < br />
                                <p className="card-text">Click the image to score a point, just don't click on the same image two times or you lose the game!  My first application built using React.</p>
                                <p className="card-text text-center"><a href="//github.com/SamTaub/react-clicky-game" target="_blank">View Github</a></p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xs-12 col-md-6 d-flex justify-content-center">
                        <div className="card border-0 m-5">
                            ...
                            <div className="card-body">
                                ...
                                < br />
                                <p className="card-text">Customize your own Marvel Superhero.  Create matching superheros to unlock trophies.</p>
                                <p className="card-text text-center"><a href="//github.com/troynwynn/MyFunkoPop" target="_blank">View Github</a></p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xs-12 col-md-6 d-flex justify-content-center">
                        <div className="card border-0 m-5">
                            ...
                            <div className="card-body">
                                ...
                                < br />
                                <p className="card-text">Search for news about your favorite NBA players and teams.  Find tickets to see your favorite team.  My first web application build 8 weeks into the University of Pennsylvania Coding Bootcamp.</p>
                                <p className="card-text text-center"><a href="//github.com/SamTaub/Project-1" target="_blank">View Github</a></p>
                            </div>
                        </div>
                    </div>
                </div>
