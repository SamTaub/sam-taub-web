        ...
        <div className="row mt-5 mb-5 align-items-center">
          ...
          <div className="col-xs-12 col-md-6 mt-5">
            <p className="p-3" id="about-me-text">
              ...
              enjoy coding every day and creating straightforward, easy to use
              web applications. I prioritize clean code and mobile
              responsiveness in my applications. Continue browsing my page to
              learn about the technologies I have used, sample projects, and how
              to connect with me.
            </p>
            <div className="row">
